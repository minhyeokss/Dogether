...
<html lang="en">
            ...
            <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active c-item">
                        <img src="./Cafe1.jpg" class="d-block w-100 c-img" alt="Slide 1">
                    ...
                    <div class="carousel-item c-item">
                        <img src="./Cafe2.jpg" class="d-block w-100 c-img" alt="Slide 2">
                        <div class="carousel-caption top-0 mt-4">
                            ...
                            data-bs-target="#booking-modal">자세히 알아보기</button>
                        </div>
                    </div>

                    <div class="carousel-item c-item">
                        <img src="./Cafe3.jpg" class="d-block w-100 c-img" alt="Slide 3">
                        <div class="carousel-caption top-0 mt-4">
                            <p class="text-uppercase fs-3 mt-5">이번주의 추천 Pick Up</p>
                    ...
                    <div class="carousel-item c-item">
                        <img src="./Cafe4.jpg" class="d-block w-100 c-img" alt="Slide 4">
                        <div class="carousel-caption top-0 mt-4">
                            <p class="text-uppercase fs-3 mt-5">이번주의 추천 Pick Up</p>
                    ...
                    <div class="carousel-item c-item">
                        <img src="./Cafe5.jpg" class="d-block w-100 c-img" alt="Slide 5">
                        <div class="carousel-caption top-0 mt-4">
                            <p class="text-uppercase fs-3 mt-5">이번주의 추천 Pick Up</p>
            ...
            <div class="find">
                <div class="find-settings">
                    ...
                    <div class="compass">
                        ...
                        현재 위치 : <div class="gps">&nbsp;서울시 강남구 역삼동</div>
                    </div>
                </div>
                
                <br><br><br>
                <ul class="finded">
                    <li><span class="badge rounded-pill">256</span><i class="fa-solid fa-utensils"></i><div class="finded-cate">식당</div></li>
                    <li><span class="badge rounded-pill">124</span><i class="fa-solid fa-hospital"></i><div class="finded-cate">병원</div></li>
                    <li><span class="badge rounded-pill">458</span><i class="fa-solid fa-mug-saucer"></i><div class="finded-cate">카페</div></li>
                    <li><span class="badge rounded-pill">67</span><i class="fa-solid fa-dog"></i><div class="finded-cate">애견카페</div></li>
                    <li><span class="badge rounded-pill">54</span><i class="fa-solid fa-hotel"></i><div class="finded-cate">숙소</div></li>
                    <li><span class="badge rounded-pill">21</span><i class="fa-solid fa-baby-carriage"></i><div class="finded-cate">애견<br>유치원</div></li>
                    <li><span class="badge rounded-pill">16</span><i class="fa-solid fa-bone"></i><div class="finded-cate">훈련소</div></li>
                    <li><span class="badge rounded-pill">59</span><i class="fa-solid fa-shop"></i><div class="finded-cate">애견<br>용품점</div></li>
                    <li><span class="badge rounded-pill">227</span><i class="fa-solid fa-tree"></i><div class="finded-cate">애견운동장<br>/산책</div></li>
                </ul>
            </div>
    
            <div class="calumn">
                <div class="news">
                    <h2>반려견 관련 칼럼 / 뉴스</h2><br>
                    <a href="#">자세히보기</a><br><br>
                    <div class="newsdetail">
                        <a href="#" class="card mb-3" style="max-width: 600px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="./News1.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <a href="#" class="card mb-3" style="max-width: 600px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="./News2.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <a href="#" class="card mb-3" style="max-width: 600px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="./News3.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <a href="#" class="card mb-3" style="max-width: 600px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="./News4.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <a href="#" class="card mb-3" style="max-width: 600px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="./News5.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><small class="text-body-secondary">Last updated 20 hours ago</small></p>
                                    </div>
                                </div>
                            </div>
                        </a>
                ...
                <div class="promotion">
                    ...
                    <div class="promotiondetail">
                        <a href="#" class="card mb-3" style="max-width: 600px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="./Promotion1.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <a href="#" class="card mb-3" style="max-width: 600px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="./Promotion2.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <a href="#" class="card mb-3" style="max-width: 600px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="./Promotion3.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <a href="#" class="card mb-3" style="max-width: 600px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="./Promotion4.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <a href="#" class="card mb-3" style="max-width: 600px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="./Promotion5.jpg" class="img-fluid rounded-start" alt="...">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
    ...
    <footer>
        <div class="footer-text">
            공지사항 / 보도자료 / 제휴문의 / 개인정보 처리방침 / 위치정보 이용약관 / 이용약관
            <br><br><br>
            (주) Acorn CEO ddd &nbsp;&nbsp;&nbsp;사업자번호 : 000-000
            <br><br><br>
            개인정보 담당자 : aaaaaaaaaaaaaa@naver.com
            <br><br><br>
            상품의 예약 이용 및 환불 등의 사항에 대한 책임은 각 판매자에게 있습니다. 또한 ㅇㅇㅇ 에 게시된 이메일 주소 수집을 거부하며, 위반시 정보 통신망법에 의해 처벌됨을 유념하시기 바랍니다.
            <br><br><br>
            CopyRight C 2023     LOGO    All rights reserved
        </div>
    </footer>
