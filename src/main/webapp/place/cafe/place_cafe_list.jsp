  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
  	...
  	<div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="checkwrap">
            <div class="checkgps">
                현재 검색 위치 : <%=session.getAttribute("location")%><br>
                <div class="gpschange">검색 위치 변경</div>
            </div>
            <div class="check">
                <div class="checkbox">편의시설
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"><label class="form-check-label" for="flexCheckDefault">주차장</label>
                </div>
                <div class="checkbox">위치
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"><label class="form-check-label" for="flexCheckDefault">실내</label>
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"><label class="form-check-label" for="flexCheckDefault">실외</label>
                </div>
                <div class="checkbox">영업시간
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"><label class="form-check-label" for="flexCheckDefault">토요일 영업</label>
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"><label class="form-check-label" for="flexCheckDefault">일요일 영업</label>
                </div>
                <div class="checkbox">사이즈
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"><label class="form-check-label" for="flexCheckDefault">소형견</label>
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"><label class="form-check-label" for="flexCheckDefault">중형견</label>
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"><label class="form-check-label" for="flexCheckDefault">대형견</label>
                </div>
            </div>
        </div>
    ...
    <%
            ...
            %>
            <div class="cards">
                <a href="place_cafe_detail.jsp?p_id=<%=place.getP_id() %>" class="card mb-3" style="max-width: 600px; margin-top:40px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="./Cafe<%=j + i * 2 + 1 %>.jpg" class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h4 class="card-title"><%=place.getP_name()%><div class="score"><%=place.getP_score() %></div></h4>
                                <p class="card-text">현재 위치에서 2.5km 거리</p>
                                <p class="card-text"><small class="text-body-secondary"><%=place.getP_category() %> | <%=place.getP_address() %> <br> #주차장 #실내 #토요일 영업 #일요일 영업 #소형견 #중형견 <br> <%=place.getP_call() %></small></p>
                            </div>
                        </div>
                    </div>
                </a>
